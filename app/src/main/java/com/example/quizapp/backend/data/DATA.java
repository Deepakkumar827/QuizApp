...
//    public static String[] questiontype=new String[]{"SWA", "SMCQ4", "IVA", "NVA", "MMCQ4" };
    public static String[] questiontype=new String[]{"SWA", "SMCQ4", "IVA", "NVA" };
//    public static String[] creator=new String[]{"Deepak", "Harish","Ritarshi", "Bablu", "Anshul","Ayush", "Abhishek",  "Rupak", "Rohit P Singh" };
    ...
    public static String[] test_type=new String[]{"Mixed", "only_SMCQ4", "only_IVA", "only_NVA", "only_SWA" };
