...
import com.example.quizapp.databinding.FragmentDashboard3Binding;
...
public class Dashboard3Fragment extends Fragment implements CardClicked3 {
    RecyclerView mainRecyclerView;
    List<Question> questionList;


    FragmentDashboard3Binding binding;
    Spinner standard;
    DatabaseReference databaseReference;
    Timer progressbarTimer;
    int progressbarCount = 0;

    List<Trie> allSubjectList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentDashboard3Binding.inflate(inflater, container, false);
        ...
        standard.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
               ...
               /* for (Trie subject : subjectParentTrie.child) {
                ...
                for (Trie item : subjectParentTrie.child) {
                    allSubjectList.add(item);
                }


                setAllData(allSubjectList);
            }
    ...
    void setAllData(List<Trie> allSubjectList) {

        mainRecyclerView = getView().findViewById(R.id.dashboard3_main_recycler_view);
        mainRecyclerView.setLayoutManager(new LinearLayoutManager(getContext()));

        mainRecyclerAdapter = new MainRecyclerAdapter(getContext(), allSubjectList, this);
    ...
    @Override
    public void onCardClicked(CardData3 cardData) {
        ...
        binding.dashboardboard3Progressbar.setVisibility(View.VISIBLE);
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.getChildrenCount() == 0) {
                    ...
                    binding.dashboardboard3Progressbar.setVisibility(View.GONE);
                ...
                for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                    ...
                    for (DataSnapshot childsnapshot : dataSnapshot.getChildren()) {
                        ...
                        if (!(type_list.contains(childsnapshot.child("type").getValue(String.class)))) {
                            continue;
                        }
                        ;
    ...
    void progressbar() {
        ...
        TimerTask timerTask = new TimerTask() {
            ...
            public void run() {
                ...
                binding.dashboardboard3Progressbar.setProgress(progressbarCount);
